...
6. **Create Checkpoint Commit:**
   ...
   - **Draft Report Content:** Create a detailed verification report including the automated test command, the manual verification steps, and the user's confirmation.
   - **Commit:** Perform the commit with a clear subject line (e.g., `conductor(checkpoint): Checkpoint end of Phase X`) and include the verification report in the message body.
...
9. **Announce Completion:** Inform the user that the phase is complete and the checkpoint has been created, with the detailed verification report included in the commit message.
